        ...
        content: [
          {
            ...
            description:
              'I worked part-time for this supplemental education provider, BrainBuilder under the franchising ownership of Dr Fong. My role covered many aspects of the company, that include tailoring our Math program to suit the best interests of individual students, providing feedback to parents, etc.',
            logo: 'BrainBuilder-logo.png',
          ...
          },
          {
            ...
            description:
              "My role is to teach children in STEM education during week-long summer camps; particularly, my class explores the world of Minecraft from a world builder's point of view. We also make sure that campers enjoy making friends, and having fun here in a safe environment.",
        ...
        content: [
          {
            ...
            description:
              'The University of Hong Kong team for DJI Robomaster Robotics Competition 2018/19. I was in-charged of designing, building, and testing 2 robots.',
            logo: 'Herkules.png',
        ...
        content: [
          {
            ...
            description:
              'Developed BlockBank, a blockchain powered e-wallet for easy and secure bank transactions.',
          ...
          },
          {
            ...
            description:
              'Developed CLAIMate, an app for petty claims featuring the court of public opinion.',
            logo: 'GLH2019-logo.png',
